...
class Template {
    ...
    public function admin_render($content, $data = NULL)
    {
        ...
        else
        {
            ...
            if ($checkRole == 6){
                $this->template['main_sidebar']    = $this->CI->load->view('admin/_templates/main_sidebar_customer', $data, TRUE);
        ...
        public function user_render($content, $data = NULL)
    {
        ...
        else
        {
            ...
            $checkRole = $_SESSION['role'];
            if ($checkRole == 6){
            $this->template['main_sidebar']    = $this->CI->load->view('employees/_templates/main_sidebar_customer', $data, TRUE);
