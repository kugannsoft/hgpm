...
class Report extends Admin_Controller {
    ...
    public function salesbydate() {
        ...
        $this->page_title->push(('Count Sale'));
    ...
    public function salesbyproduct() {
        ...
        $this->page_title->push(('Product Wise Sale'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
    ...
    public function pricereport() {
        ...
        $this->page_title->push(('Price Stock'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
    ...
    public function dailyfinalreport() {
        ...
        $this->page_title->push(('Daily Final Stock'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
    ...
    public function lowstockreport() {
        ...
        $this->page_title->push(('Minimum Stock'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function trasferreport() {
        ...
        $this->page_title->push(('Stock Tranfer'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function grnreport() {
        ...
        $this->page_title->push(('Goods Recevied Note by Grn'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function employeeproductivity() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'GRN', 'admin/report/Vastage Report');
        $this->page_title->push(('Employee Productivity Report'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        // $this->data['locations'] = $this->Report_model->loadroot();
        // $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function jobcardproductivity() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'GRN', 'admin/report/Vastage Report');
        $this->page_title->push(('Job Card Productivity Report'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->template->admin_render('admin/report/jobcardproductivity', $this->data);
    }

    public function grnreportbyproduct() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'GRN', 'admin/report/Vastage Report');
        $this->page_title->push(('Goods Recevied Note by Product'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
        $this->template->admin_render('admin/report/grnreportbyproduct', $this->data);
    }
    ...
    public function cashinout() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Stock', 'admin/report/Vastage Report');
        $this->page_title->push(('Cash In Out'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] =  $this->Report_model->loadproduct();
    ...
    public function jobsalesumbydate() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Sales', 'admin/report/salesbydate');
        $this->page_title->push(('Job Invoice Summury'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $people = array("1", "10", "13");
    ...
    public function jobsalesbyproduct() {
        ...
        $this->page_title->push(('Product Wise Job Sale'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function jobcardsummery() {
        ...
        if (in_array($_SESSION['user_id'], $people)) {
            $this->template->admin_render('admin/report/jobcardsummery', $this->data);
        } else {
            $this->template->admin_render('admin/report/jobcardsummery', $this->data);
        }
    }

    public function jobcategoryreport() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Sales', 'admin/report/jobcategoryreport');
        $this->page_title->push(('Job Category Report'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['jobsections'] = $this->db->select('*')->from('job_section')->get()->result();
        $this->data['makes'] = $this->db->select('*')->from('make')->get()->result();
        

  
            $this->template->admin_render('admin/report/jobcategoryreport', $this->data);
       
    }

    public function loadjobcategoryreport() {
        $enddate   = $_POST['enddate'];
        $startdate = $_POST['startdate'];
      
        $grouped_data = $this->db->select('
                job_section.JobSection AS JobSection,
                make.make AS MakeName,jobcardhed.appoimnetDate,
                COUNT(DISTINCT jobcardtype.JobCardNo) AS JobCardCount
            ')
            ->from('jobcardtype')
            ->join('job_section', 'job_section.JobSecNo = jobcardtype.JobTypeId', 'left')
            ->join('jobcardhed', 'jobcardhed.JobCardNo = jobcardtype.JobCardNo', 'left')
            ->join('vehicledetail', 'vehicledetail.RegNo = jobcardhed.JRegNo', 'left')
            ->join('make', 'make.make_id = vehicledetail.Make', 'left')
            ->group_by(['job_section.JobSection', 'make.make'])
            ->where('jobcardhed.appoimnetDate >=', $startdate)
            ->where('jobcardhed.appoimnetDate <=', $enddate)
            ->get()
            ->result();
        $report_matrix = [];
        foreach ($grouped_data as $row) {
            $report_matrix[$row->JobSection][$row->MakeName] = $row->JobCardCount;
        }

        $response_data = [];
        foreach ($report_matrix as $section => $makes) {
            $response_data[] = [
                'JobSection' => $section,
                'makes' => $makes 
            ];
    ...
    public function employeesalesumbydate() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Sales', 'admin/report/salesbydate');
        $this->page_title->push(('Job Sale Summery by Employee'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $people = array("1", "10", "13");
        ...
        if (in_array($_SESSION['user_id'], $people)) {
            $this->template->admin_render('admin/report/employeewisejobsale', $this->data);
        } else {
            $this->template->admin_render('admin/report/employeewisejobsale', $this->data);
        }
    }

    public function loadEmployeeWiseReport() {
        $this->output->set_content_type('application_json');
        $enddate   = $_POST['enddate'];
        $startdate = $_POST['startdate'];
        $route     = isset($_POST['route']) ? $_POST['route'] : NULL;
        $routeAr   = isset($_POST['route_ar']) ? json_decode($_POST['route_ar']) : NULL;
        $result    = $this->Report_model->genemployeewisejobsale($startdate, $enddate, $route,$routeAr);
...
//    services------------------------------------------------------------------
    ...
    public function loadreport9() {
        ...
        $route = isset($_POST['route']) ? $_POST['route'] : NULL;
        $routeAr = isset($_POST['route_ar']) ? json_decode($_POST['route_ar']) : NULL;
        $tCode = isset($_POST['tCode']) ? $_POST['tCode'] : NULL;
        $tCode_ar = isset($_POST['tCode_ar']) ? json_decode($_POST['tCode_ar']) : NULL;
        $result = $this->Report_model->cashfloatbyroute($startdate, $enddate, $route,$routeAr,$tCode,$tCode_ar);
//        var_dump($result);die();
        echo json_encode($result);
        die;
    }
    ...
    public function jobcardjson() {
        if (isset($_GET['q'])) {
            $q = strtolower($_GET['q']);
            $result = $this->Report_model->searchjobcardjson($q);
            echo json_encode($result);
            die;
        }
    }

    public function salespersonjson() {
        if (isset($_GET['q'])) {
            $q = strtolower($_GET['q']);
            $result = $this->Report_model->searchsalesperson($q);
            echo json_encode($result);
            die;
        }
    }
    ...
    public function loadjobcardsummery() {
        $this->output->set_content_type('application_json');
        $enddate   = $_POST['enddate'];
        $startdate = $_POST['startdate'];
        $route     = isset($_POST['route']) ? $_POST['route'] : NULL;
        $routeAr   = isset($_POST['route_ar']) ? json_decode($_POST['route_ar']) : NULL;
        $result    = $this->Report_model->loadjobcardsummery($startdate, $enddate, $route,$routeAr);
        echo json_encode($result);
        die;
    }

    public function loademployeeproductivity() {
        $this->output->set_content_type('application_json');
        $enddate   = $_POST['enddate'];
        $startdate = $_POST['startdate'];
    ...
    public function loadejobcardproductivity() {
        $this->output->set_content_type('application_json');
        $enddate   = $_POST['enddate'];
        $startdate = $_POST['startdate'];
        $jobcardno  = isset($_POST['customer']) ? $_POST['customer'] : NULL;
      
        $result    = $this->Report_model->loadejobcardproductivity($startdate, $enddate, $jobcardno);
        echo json_encode($result);
        die;
    }
    ...
    public function loaddailybalancedetail() {
        ...
        $bal_date = $this->db->select('MAX(date(JobInvoiceDate)) As baldate')
        ->from('jobinvoicehed')->where('JobLocation',$route)->where('date(JobInvoiceDate)<',$enddate)->get()->row()->baldate;
        ...
        //$result['salesinv']    = $this->Report_model->salesinvoicedaysalesumreportbypayment($startdate, $enddate, $route,$routeAr);
        // echo json_encode($result['salesinv']);die;
...
//        return $result;
    ...
    public function grnreportjson() {
        ...
        $this->db->join('creditgrndetails', 'creditgrndetails.GRNNo=goodsreceivenotehed.GRN_No');
    ...
    public function grnreportjsonvyproduct() {
        $enddate = $_POST['enddate'];
        $startdate = $_POST['startdate'];
        $route = isset($_POST['route']) ? $_POST['route'] : NULL;
        $from = isset($_POST['location_from']) ? $_POST['location_from'] : NULL;
        ...
        $this->db->join('productstock','productstock.ProductCode =product.ProductCode ');
        $this->db->join('goodsreceivenotedtl','goodsreceivenotedtl.GRN_Product =product.ProductCode ');
        $this->db->join('goodsreceivenotehed', 'goodsreceivenotehed.GRN_No=goodsreceivenotedtl.GRN_No');
        $this->db->join('supplier', 'supplier.SupCode=goodsreceivenotehed.GRN_SupCode');
        $this->db->join("(SELECT JobCode,SUM(jobQty) AS total_sales_qty 
        FROM jobinvoicedtl 
        INNER JOIN jobinvoicehed ON jobinvoicehed.JobInvNo = jobinvoicedtl.JobInvNo
         WHERE jobinvoicehed.IsCancel = 0
        ...
        foreach ($data->result() as $row) {
            ...
            $list[$row->ProductCode.'-'.$row->Prd_Description][] = $row;
        }
    ...
    // public function grnreportjsonvyproduct() {
    //     $this->db->select('
    //         jobinvoicedtl.JobCode,
    //         jobinvoicedtl.JobDescription AS AppearName,
    //         SUM(jobinvoicedtl.JobQty) AS total_sales_qty,
    //         productstock.Stock AS productstock,
    //         (goodsreceivenotedtl.GRN_Qty) AS GRNQTY
    //     ');
    //     $this->db->from('jobinvoicedtl');
    //     $this->db->join('jobinvoicehed', 'jobinvoicehed.JobInvNo = jobinvoicedtl.JobInvNo', 'inner');
    //     $this->db->join('productstock', 'productstock.ProductCode = jobinvoicedtl.JobCode', 'left');
    //     $this->db->join('goodsreceivenotedtl', 'goodsreceivenotedtl.GRN_Product = productstock.ProductCode', 'left');
    //     $this->db->where('DATE(jobinvoicehed.JobInvoiceDate) >=', '2025-02-01');
    //     $this->db->where('DATE(jobinvoicehed.JobInvoiceDate) <=', '2025-03-31');
    //     $this->db->where('jobinvoicehed.IsCancel', 0);
    
    //     $this->db->group_by('jobinvoicedtl.JobCode');
    //     $this->db->order_by('jobinvoicedtl.JobCode', 'ASC');
    
    //     $data = $this->db->get();
    //     $list = array();
    
    //     foreach ($data->result() as $row) {
    //         $key = $row->JobCode . '-' . $row->AppearName;
    ...
    //         $list[$key][] = array(
    //             'ProductCode' => $row->JobCode,
    //             'Prd_Description' => $row->AppearName,
    ...
    public function suppliercreditoutstanding() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Credit', 'admin/report/suppliercreditoutstanding');
        $this->page_title->push(('Supplier Outstanding Detail'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
        ...
        if (in_array($_SESSION['user_id'], $people)) {
            $this->template->admin_render('admin/report/suppliercreditoutstanding', $this->data);
        } else {
            $this->template->admin_render('admin/report/suppliercreditoutstanding', $this->data);
        }
    } 
    ...
    public function suppliercreditsummary() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Credit', 'admin/report/suppliercreditsummary');
        $this->page_title->push(('Supplier Outstanding Summary'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function loadsuppliercreditoutstanding() {
        $route = isset($_POST['route']) ? $_POST['route'] : NULL;
       ...
       $result['cr'] = $this->Report_model->loadsuppliercreditoutstanding($startdate=null, $enddate=null, $route,$supcode);
    ...
    public function loadsuppliercredisummury() {
        $route = isset($_POST['route']) ? $_POST['route'] : NULL;
        $supcode = isset($_POST['supplier']) ? $_POST['supplier'] : NULL;
    ...
    public function loadsupplierpayment() {
       ...
       $this->db->select('supplier.SupName,
                        ...
                        title.TitleName,
                        goodsreceivenotehed.GRN_InvoiceNo,
                        COALESCE(GROUP_CONCAT(DISTINCT CONCAT(grnsettlementdetails.GRNNo, "-Inv-no-",goodsreceivenotehed.GRN_InvoiceNo, " = ", grnsettlementdetails.PayAmount) SEPARATOR ", "), "No Details") AS grn_details');
                ...
                $this->db->join('grnsettlementdetails', 'grnsettlementdetails.SupPayNo = supplierpaymenthed.SupPayNo', 'left');
                $this->db->join('goodsreceivenotehed', 'goodsreceivenotehed.GRN_No  = grnsettlementdetails.GRNNo', 'left');
                $this->db->group_by('supplierpaymenthed.SupPayNo');
    ...
    public function vehiclesummery() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Credit', 'admin/report/supplierpayment');
        $this->page_title->push(('Vehicle wise Job summary'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['products'] = $this->Report_model->loadproduct();
    ...
    public function loadcustomercommission() {
     ...
     public function jobsalesbyserviceforemployee() {
        $this->breadcrumbs->unshift(1, 'Reports', 'admin/report');
        $this->breadcrumbs->unshift(1, 'Sales', 'admin/report/jobsalesbyservice');
        $this->page_title->push(('Employee Wise Job sale For Labour'));
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['locations'] = $this->Report_model->loadroot();
        $this->data['jobtype'] = $this->db->select('*')->from('jobtype')->get()->result();
        ...
        if (in_array($_SESSION['user_id'], $people)) {
            $this->template->admin_render('admin/report/employeewisejobwisejobsale', $this->data);
        } else {
            $this->template->admin_render('admin/report/employeewisejobwisejobsale', $this->data);
        }
    }

    public function loadjobsalebyservicebyjobtype() {
        $this->output->set_content_type('application_json');
        $enddate = $_POST['enddate'];
        $startdate = $_POST['startdate'];
        $product = isset($_POST['product']) ? $_POST['product'] : NULL;
        ...
        $subdep = isset($_POST['subdepartment']) ? $_POST['subdepartment'] : NULL;
        $subcat = isset($_POST['subcategory_ar']) ? json_decode($_POST['subcategory_ar']) : NULL;
        $result['pro'] = $this->Report_model->genjobreportbyservicesbyjobtype($startdate, $enddate, $route, $product,$routeAr,$dep,$subdep,$subcat);
