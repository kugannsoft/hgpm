...
class Users extends Admin_Controller {
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('cus_code', 'lang:customer_code', 'required');
		...
		$customer  = $this->db->select()->from('customer')->get()->result();
		...
		else
		{
            ...
            $this->data['cus_code'] = array(
                'name'  => 'cus_code',
                'id'    => 'cus_code',
                'class' => 'form-control',
                'value' => $this->form_validation->set_value('cus_code'),
            );
			$this->data['com'] = array(
				'name'  => 'com',
				'id'    => 'com',
