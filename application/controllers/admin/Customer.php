...
class Customer extends Admin_Controller {
    ...
    public function loadmodal_vehicleadd($id) {
        ...
        $this->data['color'] = $this->Customer_model->selectcolor();
        $this->data['paytype'] = $this->Customer_model->loadpaytype();
        $this->data['year'] = $this->Customer_model->selectyear();
        $this->data['domostrics'] = $this->Customer_model->selectdom();
    ...
    public function savecustomer() {
        ...
        $vdata['contactName'] = $_POST['contactNameV'];
        ...
        $vdata['Domostric'] = $_POST['domostric'];
        $vdata['Milage'] = $_POST['milage'];
        $cInv['AppNo'] = '1';
        $cInv['Type'] = 4;
        ...
        if($Isvehicle ==1 ){
            ...
            $isdupvehicle = $this->db->select('model')->from('vehicledetail')->get()->num_rows();
            ...
            $ismodel = $this->db->select('model')->from('model')->where('model_id',$_POST['model'])->get()->num_rows();
            // echo var_dump($ismodel);die;
            if($ismodel==0){
                ...
                // get model if exist
                // $model_id = $this->db->select('model')->from('model')->where('model_id',$_POST['model'])->get()->row()->model;
                //echo var_dump($model_id);die;
                $vdata['Model'] = $_POST['model'];
            }
        }
        
       
        $ccode = $this->Customer_model->insert_data('customer', $data, $vdata,$cdata,$cInv,$Isvehicle);
        if ($ccode) {
            echo json_encode([
                'status' => 'success',
    ...
    public function savevehicle() {
        ...
        $vdata['Milage'] = $_POST['milage'];
        $vdata['Domostric'] = $_POST['domostric'];
        $vdata['RegisterDate'] = $_POST['registerDate'];
    ...
    public function editsavevehicle() {
        ...
        $vdata['Milage'] = isset($_POST['milage'])?$_POST['milage']:'';
        $vdata['Domostric'] = isset($_POST['domostric'])?$_POST['domostric']:'';
        $vdata['RegisterDate'] = isset($_POST['registerDate'])?$_POST['registerDate']:'';
    ...
    public function allCustomers() {
        ...
        $this->datatables->where('customer.IsDelete', 0);
        // $this->datatables->order_by("customer.CusName", "ASC");
        echo $this->datatables->generate();
        die();
    }
