...
class Purchase extends Admin_Controller {
    ...
    public function all_retnprn() {
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(1, 'Purchase', 'admin/purchase');
        $this->breadcrumbs->unshift(1, 'All Return PO', 'admin/purchase/all_retnprn');
        
        $this->data['pagetitle'] = $this->page_title->show();
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->data['plv'] = $this->Purchase_model->loadpricelevel();
        $this->data['location'] = $this->Purchase_model->loadlocations();
        $this->template->admin_render('admin/purchase/all_retnprn', $this->data);
    }
    ...
    public function view_rtn_po($gno=null) {
        ...
        $this->breadcrumbs->unshift(1,  $grnNo, 'admin/purchase/view-rtn-po');
        ...
        $this->data['company'] = $this->Purchase_model->get_data_by_where('company', $id3);
         ...
         $this->data['po'] = $this->Purchase_model->loadReturnPoById($grnNo);
         $this->data['po_hed'] = $this->db->select('purchasereturnnotehed.*,supplier.*,users.first_name')
         ->from('purchasereturnnotehed')
         ->join('users','purchasereturnnotehed.PRN_User=users.id','left')
    ...
    public function addpo() {
        ...
        $this->data['plv'] = $this->Purchase_model->loadpricelevel();
        $this->data['location'] = $this->Purchase_model->loadlocations();
        $this->data['sup'] = $this->db->select('SupCode AS id,SupName AS text')->from('supplier')
    ...
    public function addprn() {
        ...
        $this->data['plv'] = $this->Purchase_model->loadpricelevel();
        $this->data['location'] = $this->Purchase_model->loadlocations();
        $this->data['sup'] = $this->db->select('SupCode AS id,SupName AS text')->from('supplier')->where('IsActive',1)->get()->result();
        $people = array("1", "3", "13");
    ...
    public function loadallretrnpos() {
    ...
    public function loadreturnproductjson() {
        ...
        echo $this->Purchase_model->loadreturnproductjson($query,$sup,$supCode);
        die;
    }
