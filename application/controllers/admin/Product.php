...
class Product extends Admin_Controller {
    ...
    public function getProductByIdAndBarcode() {
     ...
     public function getProductByIdforGrn() {
        ...
        $location = $_POST['location'];
        $price = $_POST['price'];
        $arr['productgrn'] = $this->Product_model->loadproductbypcodenew($dep, $pl);
        $arr['product'] = $this->Product_model->loadproductbypcode($dep, $pl);
        $arr['serial'] = $this->Product_model->loadproductbyserialArray($dep, $pl,$location);
        $arr['price_stock']  = $this->Product_model->loadpricestockbyid($dep,$location,$price);
        echo json_encode($arr);
        die;
    }
    ...
    public function getProductByIdforSTO() {
        ...
        $price = $_POST['price'];
        $arr['product'] = $this->Product_model->loadproductbypcode($dep, $pl);
        $arr['pro_stock']  = $this->Product_model->loadproductstockbyid($dep,$location);
        $arr['price_stock']  = $this->Product_model->loadpricestockbyid($dep,$location,$price);
    ...
    public function add_product() {
        ...
        $data['Prd_AveragecostPrice'] = $_POST['averagecost'];
