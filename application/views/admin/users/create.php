                             ...
                             <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <?php echo form_open(current_url(), array('class' => 'form-horizontal', 'id' => 'form-create_user')); ?>
                                        ...
                                        <div class="form-group">
                                            <?php echo lang('customer_code', 'cus_code', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10"><select <?php echo form_input($cus_code);?>>
                                                    <option value="0" selected="selected">Select Customer</option>
                                                    <?php foreach ($customer as $trns) { ?>
                                                       <option <?php if($trns->CusCode==$coms['value']){ ?> selected <?php } ?> value="<?php echo $trns->CusCode; ?>" ><?php echo $trns->CusCode; ?> - <?php echo $trns->CusName; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
