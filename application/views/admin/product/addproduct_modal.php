                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  name="part_no" id="part_no" placeholder="Enter Part No" readonly="readonly">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="product" class="control-label">Mercedes Part No <span class="required">*</span></label>
                    <input type="text" class="form-control"  name="orgpart_no" id="orgpart_no" placeholder="Enter Mercedes Part No" readonly="readonly">
                </div>
            ...
            <div class="col-md-4">
                <div class="pricelevelarea">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="productCode" class="control-label">Cost Price with VAT<span class="required">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="averagecost" id="averagecost" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script>
    ...
    document.getElementById('costprice').addEventListener('input', function() {
        const costPriceValue = this.value;
       
        document.getElementById('averagecost').value = costPriceValue;
    });
   ...
   $("#addSubCat,#saveDep4,#editCat").attr('disabled',false);
    ...
    $('body').on('change', '#pricelevel', function() {
        ...
        if (i > 0 && item.indexOf(i) == -1) {
            $('#pltbldata').append("<tr><td>" + i + "</td><td>" + $('#pricelevel option:selected').attr('val2') + "</td><td><input type='number' class='form-control' min='0' name='pl[" + i + "]'></td><td><span value='" + i + "' class='btn btn-xs btn-danger delete'>x</span></td></tr>");
            item.push(i);
        }
        $(this).val('0');
    });
