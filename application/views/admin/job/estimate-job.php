            ...
            <div class="col-sm-12">
                <div class="box box-success">
                    ...
                    <div class="row row-eq-height">
                        ...
                        <div class="col-sm-1">
                            <div  class="form-group">
                                <input type="text" class="form-control" onfocus="this.select();" required="required"  name="supplemetNo" id="supplemetNo" placeholder="Supplementary No" value="<?php echo $supNo;?>">
                        ...
                        <div class="col-sm-2">
                            <div  class="form-group">
                                <input type="text" class="form-control" onfocus="this.select();"  name="jobNo" id="jobNo" value="<?php echo $JobNo;?>" placeholder="Job Number">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div  class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div  class="form-group">
                                <input type="text" class="form-control" onfocus="this.select();" required="required"  name="regNo" id="regNo" placeholder="Register Number" value="<?php echo $regNo;?>">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div  class="form-group">
