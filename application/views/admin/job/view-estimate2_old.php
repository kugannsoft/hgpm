...
<table class="tblhead" style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif;" border="0">
    ...
    <tr style="text-align:left;font-size:13px;">
      ...
      <td colspan="4"  style="font-size:18px;font-weight: bold;text-align:left; "> ESTIMATE</td>
    </tr>
    <tr style="text-align:left;font-size:13px;">
    ...
    <tr style="text-align:left;font-size:12px;">
        ...
        <td colspan="2" style="text-align:left;border-right: 1px solid #000;border-top: 1px solid #000;">&nbsp;&nbsp;SUPPLIMENTRY NO.</td>
    </tr>
    <tr style="text-align:left;font-size:12px;">
        <td> &nbsp;</td>
        ...
        <?php if($estHed->EstJobType==1){?>
            ...
            <?php } ?>
                ...
                <?php  } ?>
                    ...
                    <tr>
                        <td style="font-size: 11px;text-align: center; width: 100%;"colspan="4"> WE USED COMPUTER BASE …........... 2K COLOUR  MIXING AND BAKE BOOTH FOR PAINTNG.</td>
                   
                    </tr>
                    <tr>
                    <td style="font-size: 11px; width: 100%;" colspan="4">VAT No: 103338034 - 7000</td>
                     
                    </tr>     
                    <tr>
                    <td style="font-size: 11px; text-align: center; width: 25%;"></td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">...............</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">...............</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">...............</td>
                    </tr>    
                    <tr>
                        <td style="font-size: 11px; text-align: center; width: 25%;">VAT would be added to net invoice valve.</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">Name & signature(customer)</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">Name & signature (assessor)</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">Signature (GHPM)</td>
                    </tr>
