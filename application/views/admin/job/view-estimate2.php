        ...
        <?php if($estHed->EstJobType==1){?>
            <thead style="display: table-header-group;">
                ...
                <tr style="text-align:left;font-size:13px;">
                    ...
                    <td colspan="5" style="font-size:18px;font-weight: bold;text-align:center;">ESTIMATE</td>
                </tr>
            <tr style="text-align:left;font-size:13px;">
                <td colspan="2" rowspan="5" style="border:1px solid #000; font-size:13px; width:100px; padding:5px; vertical-align: top;">
                            ...
                            <span id="lbladdress2">
                                Telphone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $invCus->LanLineNo; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <td>&nbsp;&nbsp;</td>   
                       <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-top: 1px solid #000;width:200px;" colspan="5">&nbsp;&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo (new DateTime($estHed->EstDate))->format('d-m-Y H:i:s'); ?></td>
                       ...
                       <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;" colspan="1"></td>
                        ...
                        <tr style="text-align:left;font-size:12px;border:1px solid #000; ">
                           <td style="border:1px solid #fff;border-right: 1px solid #000;border-bottam:1px solid #fff;">&nbsp;&nbsp;</td>   
                               <td style="text-align:left;border-left:1px solid #000;border-top:1px solid #fff;" colspan="4">&nbsp;&nbsp;Reg.No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo $estHed->EstRegNo;?></td>

                               
                           </tr>
                           <tr style="text-align:left;font-size:12px;border:1px solid #000;">
                           <td style="border:1px solid #fff;border-right: 1px solid #000;border-bottam:1px solid #fff;">&nbsp;&nbsp;</td>     
                               <td style="text-align:left;;border-top:1px solid #fff;" colspan="3"> &nbsp;&nbsp;Estimate  NO:<?php echo $estHed->EstimateNo ?></td>
                              
                               <td colspan="2" style="text-align:left;;border-top:1px solid #fff;font-size:10px;">&nbsp;&nbsp;Odo Meter&nbsp;:<?php  if(isset($invVehi)){ echo $invVehi->Milage;}?></td>
                           </tr>
                           <tr style="text-align:left;font-size:12px;border:1px solid #000;">
                           <td style="border:1px solid #fff;border-right: 1px solid #000;border-bottam:1px solid #fff;">&nbsp;&nbsp;</td>    
                              <td style="text-align:left;;border-top:1px solid #fff;" colspan="3">&nbsp;&nbsp;Make&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php if(isset($invVehi)){ echo $invVehi->make;} ?>&nbsp;&nbsp;</td>
                              <td colspan="4" style="text-align:left;;border-top:1px solid #fff;font-size:10px;">&nbsp;&nbsp;Model&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php  if(isset($invVehi)){ echo $invVehi->model;}?></td>
                              
                          </tr>
                          
                           <tr style="text-align:left;font-size:12px;border:1px solid #000;">
                           <td style="border:1px solid #fff;border-right: 1px solid #000;border-bottam:1px solid #fff;">&nbsp;&nbsp;</td>     
                               <td style="text-align:left;;border-top:1px solid #fff;" colspan="4">&nbsp;&nbsp;Chassis No&nbsp;&nbsp;:<?php if($estHed->Supplimentry>0){ echo $estHed->Supplimentry;}?><?php if(isset($invVehi)){ echo $invVehi->ChassisNo;}?></td>
                       ...
                       <tr style="line-height: 20px;background-color:#fff !important;border:1px solid;font-size:10px;">
                            ...
                            <th  style="font-weight:bold;;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;;width:45%; ">Description</th>
                            <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;;width:5%; "></th>
                            <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width:5%;" class='text-right'>Qty</th>
                            <th  style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width: 10px;%; " class='text-right'>Unit price</th>
                            <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width:10%;" class='text-right'>Quoted Amount</th>

                            <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;text-align:center;">Amended Amount</th>
            ...
            <?php } ?>
                <tbody>
                    ...
                    foreach ($estDtl as $key=>$estdtl) { ?>
                     <?php if($estHed->EstJobType==1){
                        ...
                        ?>
                    <tr style="!important;">
                        <td style="border-bottom:1px solid #000;border-left:1px solid #000;border-top:1px solid #000;border-right:1px solid #000;padding: 5px"></td>
                        <td colspan="7" style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000; font-size:10px;padding: 5px"><b><?php echo $key;?></b></td>
                    </tr>
                     <?php 
                      foreach ($estdtl AS $dtl) { ?>
                       <tr style="font-size:10px;">
                       <td style="text-align:center;border-bottom:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;padding: 5px"><?php echo $i;?></td>
                       <td style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;padding: 5px"><?php echo $dtl->EstJobDescription?></td>
                       <td class="text-right" style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;padding: 5px"><?php echo $dtl->EstPartType?></td>
                       <td class="text-right" style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;padding: 5px"><?php echo ifzero($dtl->EstQty);?></td>
                       <td class="text-right" style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;padding: 5px"><?php if($dtl->EstIsInsurance==0){echo ifzero($dtl->EstNetAmount/$dtl->EstQty);} ?></td>
                       <td class="text-right" style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;padding: 5px"><?php if($dtl->EstIsInsurance==0){echo ifzero($dtl->EstNetAmount);}else{echo $dtl->EstInsurance;} ?></td>
                    ...
                    <tr style="!important;">
                        <td style="border-bottom:1px solid #000;border-left:1px solid #000;border-top:1px solid #000;border-right:1px solid #000;padding: 5px"></td>
                        <td colspan="7" style="border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000;padding: 5px;font-size:10px;"><b><?php echo $key;?></b></td>
                    </tr>
                    <?php 
                     foreach ($estdtl AS $dtl) { ?>
                    <tr style="font-size:10px;">
                ...
                <?php  } ?>
                    ...
                    <?php if($estHed->EstJobType==2){ ?>
                        ...
                        <tr>
                            <th colspan="5" style="text-align:right;font-size:10px;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000;">Estimate Amount &nbsp;&nbsp; Rs</th>
                            <th style='text-align:right;padding: 5px;font-size:10px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'><?php echo number_format($estHed->EstimateAmount,2) ?>&nbsp;</th>
                            <th style='text-align:right;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'></th>
                        </tr>
                        <?php if($estHed->EstVatAmount>0){ ?>
                        <tr>
                            <th colspan="5" style="text-align:right;font-size:10px;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000;">VAT Amount &nbsp;&nbsp; Rs</th>
                            <th style='text-align:right;padding: 5px;font-size:10px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'><?php echo number_format($estHed->EstVatAmount,2)?>&nbsp;</th>
                            <th style='text-align:right;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'></th>
                        </tr>
                        <?php } ?>
                        <?php if($estHed->EstVatAmount>0){ ?>
                        <tr>
                            <th colspan="5" style="text-align:right;font-size:10px;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000;">Total Amount with VAT &nbsp;&nbsp; Rs</th>
                            <th style='text-align:right;padding: 5px;font-size:10px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'><?php echo number_format($estHed->EstNetAmount,2) ?>&nbsp;</th>
                            <th style='text-align:right;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'></th>
                        </tr>
                        <?php  }elseif($estHed->EstVatAmount<0){ ?>
                            <tr>
                            <th colspan="5" style="text-align:right;font-size:10px;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000;">Total Amount&nbsp;&nbsp; Rs</th>
                            <th style='text-align:right;padding: 5px;font-size:10px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'><?php echo number_format($estHed->EstNetAmount,2) ?>&nbsp;</th>
                            <th style='text-align:right;padding: 5px;!important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'></th>
                        </tr> 
                        <?php } ?>
                    <?php  }elseif($estHed->EstJobType==1){ ?>
                        ...
                        <tr>
                            <th colspan="5" style="text-align:right;padding: 5px;font-size:10px; !important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;border-left:1px solid #000;">Estimate Amount &nbsp;&nbsp; Rs</th>
                            <th style='text-align:right;padding: 5px;font-size:10px; !important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'><?php echo number_format($estHed->EstimateAmount,2) ?>&nbsp;</th>
                            <th style='text-align:right;padding: 5px; !important;border-bottom:1px solid #000;border-right:1px solid #000;border-top:1px solid #000;'></th>
                        </tr>
                        <?php if($estHed->EstVatAmount>0){ ?>
                    ...
                    <?php } ?>
                        <tr>
                            <th colspan="6"  style="text-align:left">Remark: <span id="lblremark1"><?php echo $estHed->remark ?></span><br><br>
                ...
                <table style="border-collapse:collapse;width:700px;font-family: Arial, Helvetica, sans-serif;" border="1">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 11px; text-align: center; width: 25%;">AP/GP = Genuine parts</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">NON = Non genuine parts</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">UP = Used parts</td>
                        <td style="font-size: 11px; text-align: center; width: 25%;">MR = Market rate</td>
                    </tr>

                    <tr>
                </table>
                <table id="footer" style="border-collapse:collapse;width:700px;padding:5px;font-size:12px; margin-top:20px;" border="1">
                    <tr>
