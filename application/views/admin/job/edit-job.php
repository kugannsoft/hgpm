                ...
                <div class="box box-success">
                        ...
                        <div class="row row-eq-height">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="labour" id="labour" class="form-control" required="required">
                                            <option value="">Select an Service Employee</option>
                                            <?php foreach ($labour as $trns) { ?>
                                                <option value="<?php echo $trns->RepID; ?>" <?php if($trns->RepID == $JobHed->Jlabour){ ?> selected="selected" <?php } ?> ><?php echo $trns->RepName; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="jobLocation" id="jobLocation" class="form-control" required="required">
                                            <option value="">Select a Job Location</option>
                                            <?php foreach ($joblocation as $trns) { ?>
                                                <option value="<?php echo $trns->id; ?>" <?php if($trns->id == $JobHed->JobLocation){ ?> selected="selected" <?php } ?> ><?php echo $trns->location_name; ?></option>
                                            <?php } ?>
                                        </select>
                                        <!-- <input type="text" class="form-control" required="required"  name="advisorName" id="advisorName" placeholder="Service Advisor Name" value="<?php echo $company['SAdvisorName'];?>"> -->
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row"><div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="submit" class="btn btn-info pull-left" id='updateJob' value="Update Job"></div>
                                        <div class="col-sm-2">
