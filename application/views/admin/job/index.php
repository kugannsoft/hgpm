                        ...
                        <div class="row row-eq-height">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" required="required"  name="regNo" id="vehicleNo" value="<?php echo ($regno);?>" placeholder="Ex: WP AAA-2312">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label for="advisorName" class="col-sm-5 control-label">Service Employee <span class="required"></span></label>
                                    <div class="col-sm-7">
                                        <select name="labour" id="labour" class="form-control">
                                            <option value="">Select an Service Employee</option>
                                            <?php foreach ($labour as $trns) { ?>
                                 ...
                                 <div class="form-group">
                                    <label for="advisorName" class="col-sm-5 control-label">Job Location <span class="required"></span></label>
                                    <div class="col-sm-7">
                                        <select name="jobLocation" id="jobLocation" class="form-control">
                                            <option value="">Select a Job Location</option>
                                            <?php foreach ($joblocation as $trns) { ?>
                                                <option value="<?php echo $trns->id; ?>" ><?php echo $trns->location_name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="invDate" class="col-sm-5 control-label">Customer Request Notes<span class="required">*</span></label>
                                    <div class="col-sm-7">
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <input type="text" class="form-control" name="jobdesc" id="jobdesc" placeholder="" style="width:250px;"></span>
                                                    <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    <label for="invDate" class="col-sm-5 control-label">Amount<span class="required">*</span></label>
                                    <div class="col-sm-7">
                                            <div class="input-group">
                                        
                                                    <input type="text" class="form-control" name="jobamount" id="jobamount" placeholder="">
                                ...
                                <div class="form-group" style="width:700px;">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" class="form-control" name="jobAmArr"  id="jobAmArr">
