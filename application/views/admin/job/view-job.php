        ...
        var producttbl = $('#producttbl').dataTable({
            ...
            "columns":
                    [
                        ...
                        {"data": "JCustomer","visible": true,"searchable": true},
                        {
                        ...
                        },
                        {
                            ...
                            "data": null, orderable: false, searchable: false,
                            mRender: function (data, type, row) {
                                if (row.IsCancel == 1 || row.is_invoice==1) {
                                    return '<a href="#" class="btn btn-xs btn-primary" disabled>Invoice</a>';
                                } else {
