    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <label for="product" class="control-label">Flat Qty <span class="required">*</span></label>
                    <input type="number" class="form-control" required="required" value="<?php echo $trans->FlatQty?>"  name="flatQty" id="flatQty">
                </div>
                <div class="form-group">
