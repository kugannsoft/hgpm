    ...
    <section class="content">
      <div class="row">
        ...
        <table id="tbl_est_data" style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:700px;padding:1px;font-size:11px;" align="center" border="0">
            ...
            <?php if ($invHed->JobCreditAmount > 0) { $invtype= 'CREDIT'; } else { $invtype= 'CASH'; } ?><?php echo $invtype; ?>&nbsp;SALE INVOICE
            </td>
            </tr>
            <tr style="text-align:left;font-size:13px;">
            <td colspan="2" rowspan="5" style="border:1px solid #000;font-size:15px;width:430px;padding: 5px;" v-align="top">
                ...
                <td>&nbsp;&nbsp;</td>   
                <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-top: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;Date and Time:<?php echo (new DateTime($invHed->SalesDate))->format('d-m-Y H:i:s'); ?></td>
                <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;" colspan="2"></td>
            </tr>
                    <tr style="text-align:left;font-size:12px;">
                        <td></td>   
                        
                        <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;Invoice No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->SalesInvNo?></td>
                <td style="font-size:12px;text-align: left;border-right: 1px solid #000;" colspan="1"></td>
                    </tr>
                    <tr style="text-align:left;font-size:12px;">
                    
                       <td></td>   
                        
                        <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td style="font-size:12px;text-align: left;border-right: 1px solid #000;" colspan="1"></td>
                    </tr>
                    <tr style="text-align:left;font-size:12px;">
                        ...
                        <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-bottom: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td style="font-size:12px;text-align: left;border-right: 1px solid #000;border-bottom: 1px solid #000;" colspan="1"></td>
                    ...
                    foreach ($invDtl AS $invdata) {
                      ...
                      if($invHed->SalesInvType==1 || $invHed->SalesInvType==3){
                        ...
                        <tr style="line-height: 15px;!important;">
                            ...
                            <td colspan="2" style="border-bottom:1px solid #000 ;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo $invdata->SalesProductName."<br>".$invdata->SalesSerialNo;?></td>
                            <td class='text-right' style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format(($invdata->SalesQty),2)?></td>
                            <td class='text-right' style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format(($invdata->SalesUnitPrice),2)?></td>
                            <td class='text-right' style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format($invdata->SalesDisValue,2)?></td>
                            <td class='text-right' colspan="2" style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format(($invdata->SalesInvNetAmount),2)?></td>
                        </tr>
                    <?php $i++; 
            ...
            if($invHed->SalesInvType==2){ ?>
                <tr id="rowTotal">
                    ...
                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalPOAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesInvAmount,2); ?></th>
                </tr>

                <?php }else{ ?> 

                  <tr id="rowTotal">
                    <th colspan="5" style='text-align:right;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000'>SUB TOTAL &nbsp;&nbsp;</th>
                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalPOAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesInvAmount,2); ?></th>
                </tr>
                ...
                <tr id="rowTotal">
                    <th colspan="5" style='text-align:right;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000'>Discount &nbsp;&nbsp;</th>
                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalPOAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesDisAmount,2); ?></th>
                </tr>
                <?php } ?>
                ...
                <tr id="rowTotal">
                    <th colspan="5" style='text-align:right;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000'>VAT Amount &nbsp;&nbsp;</th>
                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalPOAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesVatAmount,2); ?></th>
                </tr>
                ...
                <tr id="rowTotal">
                    <th colspan="5" style='text-align:right;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000'>NBT Amount &nbsp;&nbsp;</th>
                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalPOAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesNbtAmount,2); ?></th>
                </tr>
                ...
                <tr id="rowTotal">
                    <th colspan="5" style='text-align:right;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000'><?php echo $invHed->SalesShippingLabel; ?> &nbsp;&nbsp;</th>
                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalPOAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesShipping,2); ?></th>
                </tr>
                ...
                <tr id="rowNET">
                <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>Total &nbsp;&nbsp;</th>
                ...
                <?php if($invHed->SalesCashAmount>0){
                 ...
                 <tr id="rowDiscount">
                <th colspan="5" style='text-align:right;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000;'>Total &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalDicount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesCashAmount,2);?></th>
                ...
                <?php } ?>
                  ...
                  <tr  id="rowNBT">
                <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>Bank Transfer &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalDicount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesBankAmount,2);?></th>
                ...
                <?php if($invHed->SalesReturnPayment>0){
                  ...
                  <tr  id="rowNBT">
                <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>Return Payment &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalDicount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesReturnPayment,2);?></th>
                ...
                <?php if($invHed->SalesCreditAmount>0){
                  ...
                  <tr  id="rowNBT">
                <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>TOTAL PAYABLE &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;border-bottom: 1px solid #000;">&nbsp;&nbsp;Rs.</th>
                    <th id="lbltotalDicount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'><?php echo number_format($invHed->SalesCreditAmount,2);?></th>
