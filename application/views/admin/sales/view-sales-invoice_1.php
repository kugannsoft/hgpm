                        ...
                        <table id="tbl_est_data"
                            ...
                            <thead style="display: table-header-group;">
                                ...
                                <tr style="text-align:left;font-size:13px;">
                                    ...
                                    <td colspan="4" style="font-size:18px;font-weight: bold;text-align:center;">
                                        <?php if ($invHed->JobCreditAmount > 0) { $invtype= 'CREDIT'; } else { $invtype= 'CASH'; } ?><?php echo $invtype; ?>&nbsp;SALE
                                        INVOICE
                                    </td>
                                </tr>
                                <tr style="text-align:left;font-size:13px;">
                                    <td colspan="2" rowspan="5"
                                        style="border:1px solid #000;font-size:15px;width:430px;padding: 5px;"
                                        v-align="top">
                                        <span style="font-size: 12px"><a
                                                href="<?php echo base_url('admin/payment/view_customer/').$invCus->CusCode ?>">Customer
                                                Name :<?php echo $invCus->DisplayName;?></a></span><br>
                                        <?php if ($invCus->DisType==4): ?>
                                        <?php echo $invCus->ContactPerson;?><br>
                                        <?php endif ?>
                                        <span style="font-size: 12px">Customer Address :
                                            <?php if ($invCus->DisType!=4){ ?>
                                            <?php echo ($invCus->Address01).",".$invCus->Address02;?>
                                            <?php echo $invCus->Address03;?>
                                            <?php }else{ ?>
                                            <?php echo nl2br($invCus->ComAddress);?>
                                            <?php } ?>
                                        </span><br>
                                        <span style="font-size: 12px" id="lbladdress2">Customer TP :
                                            <?php echo $invCus->LanLineNo;?> Mobile :
                                    ...
                                    <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-top: 1px solid #000;width:200px;"
                                        colspan="4">&nbsp;&nbsp;Date and
                                        Time:<?php echo (new DateTime($invHed->SalesDate))->format('d-m-Y H:i:s'); ?>
                                    </td>
                                ...
                                <tr style="text-align:left;font-size:12px;">
                                    ...
                                    <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"
                                        colspan="4">&nbsp;&nbsp;Invoice
                                        No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->SalesInvNo?></td>
                                    <td style="font-size:12px;text-align: left;border-right: 1px solid #000;"
                                        colspan="1"></td>
                                </tr>
                                <tr style="text-align:left;font-size:12px;">
                                ...
                                <tr style="text-align:left;font-size:12px;">
                                    ...
                                    <td style="font-size:12px;text-align: left;border-right: 1px solid #000;border-bottom: 1px solid #000;"
                                        colspan="1"></td>
                            ...
                            <tbody>
                                ...
                                <tr style="line-height: 15px;!important;">
                                    ...
                                    <td class='text-right'
                                        style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">
                                        &nbsp;&nbsp;<?php echo number_format(($invdata->SalesQty),2)?></td>
                                    <td class='text-right'
                                        style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">
                                        &nbsp;&nbsp;<?php echo number_format(($invdata->SalesUnitPrice),2)?></td>
                                    <td class='text-right'
                                        style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">
                                        &nbsp;&nbsp;<?php echo number_format($invdata->SalesDisValue,2)?></td>
                                    <td class='text-right' colspan="2"
                                        style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">
                                        &nbsp;&nbsp;<?php echo number_format(($invdata->SalesInvNetAmount),2)?></td>
                                </tr>
                                <?php $i++; 
                            ...
                            <tfoot>
                                ...
                                <tr id="rowTotal">
                                    ...
                                    <th id="lbltotalPOAmount"
                                        ...
                                        <?php echo number_format($invHed->SalesInvAmount,2); ?></th>
                                </tr>
                                ...
                                <tr id="rowTotal">
                                    ...
                                    <th id="lbltotalPOAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesDisAmount,2); ?></th>
                                </tr>
                                <?php } ?>
                                ...
                                <tr id="rowTotal">
                                    ...
                                    <th id="lbltotalPOAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesVatAmount,2); ?></th>
                                </tr>
                                ...
                                <tr id="rowTotal">
                                    ...
                                    <th id="lbltotalPOAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesNbtAmount,2); ?></th>
                                </tr>
                                ...
                                <tr id="rowTotal">
                                    ...
                                    <th
                                        style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;border-left: 1px solid #000'>
                                        <?php echo $invHed->SalesShippingLabel; ?> &nbsp;&nbsp;</th>
                                    <th colspan="" style="text-align:center;border-bottom: 1px solid #000;">
                                        &nbsp;&nbsp;Rs.</th>
                                    <th id="lbltotalPOAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesShipping,2); ?></th>
                                </tr>
                                ...
                                <tr id="rowDiscount">
                                    ...
                                    <th id="lbltotalDicount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesCashAmount,2);?></th>
                                ...
                                <th id="lbltotalDicount"
                                    style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                    <?php echo number_format($invHed->SalesNetAmount,2);?></th>
                                ...
                                <tr id="rowNBT">
                                    ...
                                    <th id="lbltotalDicount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesBankAmount,2);?></th>
                                ...
                                <tr id="rowNBT">
                                    ...
                                    <th id="lbltotalDicount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesChequeAmount,2);?></th>
                                ...
                                <tr id="rowNBT">
                                    ...
                                    <th id="lbltotalDicount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesReturnPayment,2);?></th>
                                ...
                                <tr id="rowNBT">
                                    ...
                                    <th id="lbltotalDicount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;'>
                                        <?php echo number_format($invHed->SalesCreditAmount,2);?></th>
                        ...
                        <table id="tbl_est_data"
                            ...
                            <tr>
                                ...
                                <td style="border-bottom:1px dashed #000;text-align: center;">
                                    <?php echo $invHed->SalesReceiver; ?></td>
                                <td style="">&nbsp;</td>
                                <td style="border-bottom:1px dashed #000;text-align: center;">
                                    <?php echo $invHed->SalesRecNic; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="5" style="text-align:center;font-size: 18px;"><i></i></td>
                            </tr>
                           ...
                           <table id="footer"
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="1" style="border:1px solid #000; width:200px; text-align:center;">
                                           ...
                                           <?php echo $invHed->first_name." ".$invHed->last_name ?><br>
                                            Prepared By
                                        </th>
