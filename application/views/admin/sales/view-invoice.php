    ...
    <section class="content">
      <div class="row">
        ...
        <table id="tbl_est_data" style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:700px;padding:1px;font-size:11px;" align="center" border="0">
            ...
            <tr style="text-align:left;font-size:13px;">
                    <td colspan="3" rowspan="5" style="border:1px solid #000; font-size:13px; width:100px; padding:5px; vertical-align: top;">
                    <?php if (!empty($invHed->JInsCompany)) : ?>
                    Invoice To&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;  : <?php echo $invHed->JInsCompany; ?>
                    <?php endif; ?>
                    <br>  
                    Customer Code&nbsp;: <?php echo $invCus->CusCode; ?>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    <strong>Vehicle No: <?php echo $invHed->regNo; ?></strong><br> 
                ...
                <br>
                <span id="lbladdress2">
                        Model&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $invVehi->model; ?>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                        Make&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $invVehi->make; ?>
                    </span>
                </td>

                <td>&nbsp;&nbsp;</td>   
                <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-top: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;Date and Time:<?php echo (new DateTime($invHed->date))->format('d-m-Y H:i:s'); ?></td>
                <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;" colspan="1"></td>
                    ...
                    <tr style="text-align:left;font-size:12px;">
                        ...
                        <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;Estimate No&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->JobEstimateNo ?></td>
                <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;" colspan="1"></td>
                    </tr>
                    <tr style="text-align:left;font-size:12px;">
                       ...
                       <td></td>   
                        ...
                        <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;Invoice No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->JobInvNo ?></td>
                        <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;" colspan="1"></td>
                    </tr>
                    <tr style="text-align:left;font-size:12px;">
                        ...
                        <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-bottom: 1px solid #000;width:200px;"colspan="4">&nbsp;&nbsp;Job No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->jobcardNo ?></td>
                        <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;" colspan="1"></td>
                    
                    </tr>
                    
                    <tr style="text-align:left;font-size:13px;">
                       
                        <td style="font-size:11px;text-align:right;border-right: 1px solid #000;border-left: 1px solid #000;"></td>
                        <td style=""></td>
                        <td colspan="3" style="font-size:11px;text-align:right;border-right: 1px solid #000;"></td>
                    </tr>
                    <tr>
                    ...
                    <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center; width:3%;">No</th>
                    <th colspan="2" style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width:48%; ">Item & Description</th>
                    <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width:8%; ">Qty</th>
                    <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center; width:12%;" class='text-right'>Rate</th>
                    <th style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center; width:12%;" class='text-right'>Discount</th>
                    <th colspan="2" style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width:17%; " class='text-right'>Amount</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                foreach ($invDtl AS $key=>$invdata) { ?>
                    <tr style="!important;!important;">
                        <td style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;"></td>
                        <td colspan="2" style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;"><b>&nbsp;&nbsp;<?php echo $key?></b></td>
                        <td style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;"></td>
                        <td style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;"></td>
                        <td style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;"></td>
                        <td colspan="2" style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;"></td>
                    </tr>
                    <?php foreach ($invdata AS $inv) { ?>
                        <tr>
                            <td style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;">&nbsp;&nbsp;<?php echo $i?></td>
                            <td colspan="2" style="border-bottom:1px solid #000 ;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo $inv->JobDescription?></td>
                            <td class='text-right' style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format($inv->JobQty,3)?></td>
                            <td class='text-right' style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format($inv->JobPrice,2)?></td>
                            <td class='text-right' style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format($inv->JobDiscount,2)?></td>
                            <td class='text-right' colspan="2" style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">&nbsp;&nbsp;<?php echo number_format(($inv->JobQty*$inv->JobPrice)-$inv->JobDiscount,2)?></td>
                        </tr>
                        <?php $i++; } ?>
                <?php } ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;'>SUB TOTAL &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;">&nbsp;&nbsp;Rs.</th>
                    <th id="totalAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;'><?php echo number_format($invHed->JobTotalAmount,2); ?></th>
                </tr>

                <?php if($invHed->JobTotalDiscount>0){?>
                <tr>
                    <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;'>DISCOUNT &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;">&nbsp;&nbsp;Rs.</th>
                    <th id="totalAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;'><?php echo number_format($invHed->JobTotalDiscount,2); ?></th>
                <?php } ?>
                </tr>
                <?php if(($invHed->JobTotalDiscount>0) &&($invHed->JobAdvance>0)){?>
                <tr>
                <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;'>AFTER DIS &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;">&nbsp;&nbsp;Rs.</th>
                    <th id="totalAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;'><?php echo number_format($invHed->JobTotalAmount-$invHed->JobTotalDiscount,2); ?></th>
                ...
                <tr>
                <th colspan="5" style='text-align:right;border-left:1px solid  #000;border-bottom:1px  solid  #000;font-size: 10px;font-weight: normal;text-align: left;'></th>
                    <th style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;'>ADVANCE &nbsp;&nbsp;</th>
                    <th colspan="" style="border-top:1px solid #000;text-align:center;">&nbsp;&nbsp;Rs.</th>
                    <th id="totalAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;'><?php echo number_format($invHed->JobAdvance,2); ?></th>
                ...
                <tr>
                    <th colspan="5" style="border-left: 1px solid #000;border-top:1px solid #000;border-bottom:1px  solid  #000;"></th>
                    <th style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;'> TOTAL &nbsp;&nbsp;</th>
                    <th style="border-left: 1px solid #000;border-top:1px solid #000;border-bottom:1px  solid  #000;text-align:center;">&nbsp;&nbsp;Rs.</th>
                    <th id="netAmount" style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;'><?php echo number_format($invHed->JobNetAmount-$invHed->JobAdvance,2) ?></th>
                </tr>
            </tfoot>
        </table>
        ...
        <table id="tbl_est_data" style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:700px;padding:1px;font-size:11px;" align="center" border="0">
            ...
            <tr style="text-align:left;font-size:13px;">
                <td colspan="3" rowspan="5" style="border:1px solid #000; font-size:13px; width:250px; padding:5px; vertical-align: top;">
                   Remarks:<?php echo ($invHed->InvRemark) ?>
            ...
            <?php if (!empty($invCus->DocNo)) : ?>
                    <tr>
                        <th>&nbsp;&nbsp;</th>
                        <th>&nbsp;&nbsp;</th>
                        <th style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;width:12%">&nbsp;&nbsp; SUB TOTAL</th>
                                <th style="border-left: 1px solid #000;border-top:1px solid #000;;border-bottom:1px  solid  #000;text-align:center;width:5%">Rs.</th>
                                <th id="totalAdvance" style="border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;text-align:right;width:8%"><?php echo number_format(($invHed->JobTotalAmount-$invHed->JobTotalDiscount)-((($invHed->JobTotalAmount-$invHed->JobTotalDiscount)*18)/(118)),2); ?></th>
                    </tr>
                    <tr>
                        <th>&nbsp;&nbsp;</th>
                        <th>&nbsp;&nbsp;</th>
                        <th style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;width:12%">&nbsp;&nbsp; VAT&nbsp;&nbsp;18%</th>
                                <th style="border-left: 1px solid #000;border-top:1px solid #000;;border-bottom:1px  solid  #000;text-align:center;width:5%">Rs.</th>
                                <th id="totalAdvance" style="border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;text-align:right;width:8%"><?php echo number_format((($invHed->JobTotalAmount-$invHed->JobTotalDiscount)*18)/(118),2);?></th>
                    </tr>
                    ...
                    <tr>
                        <th>&nbsp;&nbsp;</th>
                        <th>&nbsp;&nbsp;</th>
                        <th style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;width:12%">&nbsp;&nbsp; TOTAL &nbsp;&nbsp;</th>
                                <th style="border-left: 1px solid #000;border-top:1px solid #000;border-bottom:1px  solid  #000;text-align:center;width:5%">Rs.</th>
                                <th id="netAmount" style="border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;text-align:right;width:8%"><?php echo number_format($invHed->JobTotalAmount-$invHed->JobTotalDiscount,2) ?></th>
                    </tr>
        ...
        <table id="footer" style="border-collapse:collapse;width:700px;padding:5px;font-size:12px;" border="1">
            <tr>
                <th style="text-align:left;font-size:12px; width:500px;">
                ...
                <th colspan="1" style="border:1px solid #000; width:200px; text-align:center;">
                    <br><br>
        ...
        <table id="tbl_est_data" style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:700px;padding:1px;font-size:11px;" align="center" border="0">
          ...
          <tr>
              <td  style="text-align:center;font-size:16px;font-style:italic;color:red;">
              24 Hours road side assistance &nbsp;&nbsp;&nbsp;&nbsp; 0710 378378 
        ...
        <div class="modal fade bs-payment-modal-lg" id="modelInvoice2" tabindex="-1" role="dialog" aria-hidden="false">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="row" id="printArea2" align="center" style='margin:5px;'>
                        <table style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif;font-size:14px;" border="0">
        ...
        <table style="border-collapse:collapse;width:590px;margin:5px;font-family: Arial, Helvetica, sans-serif;" border="0"  align="center">
            ...
            <tr style="text-align:left;font-size:14px;">
                <td colspan="3" rowspan="7">
                    <TABLE  style="text-align:left;font-size:14px;margin-left: 5px;">
                        <tr style="text-align:left;">
                            <td colspan="3"></td>
                        </tr>
                        <tr style="text-align:left;">
            ...
            <?php if($invjob){
              ...
              $noofjob=0;$refno=0;$nextService=0;
                      ...
                      <table id="tbl_est_data" style="border-collapse:collapse;width:590px;padding:5px;font-size:12px; margin-right: 220px;" align="center" border="0"> 
                          <tbody>
