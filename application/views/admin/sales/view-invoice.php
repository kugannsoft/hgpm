    ...
    <div class="box-header" style="background: #b4f3c8">
        ...
        <div class="col-sm-8">
            <div class="row">
                ...
                <div class="col-sm-2"><button type="button" id="btnPrint"
                        class="btn btn-primary btn-sm btn-block">Print</button></div>
                <?php }
                ...
                <div class="col-sm-1"><?php if($invHed->IsPayment==0){?>
                ...
                <div class="col-sm-2"><?php if($invHed->IsCancel==0){?>
                    <button type="button" <?php echo $disabled;?> id="btnCancel"
                        class="btn btn-danger btn-sm btn-block">Invoice Cancel</button><?php } ?>
                </div>
                <?php } ?>
                <?php if (in_array("SM102", $blockDelete) || $blockDelete == null) { ?>
                <div class="col-sm-3"><?php if($invHed->IsCancel==0 && $invHed->IsPayment==1){?>
                    <button type="button" <?php echo $disabled;?> id="btnPayCancel"
                        class="btn btn-danger btn-sm btn-block">Payment Cancel</button><?php } ?>
                </div>
                <?php }  } ?>
                    ...
                    <div class="table-content">
                        ...
                        <table id="tbl_est_data"
                            ...
                            <thead style="display: table-header-group;">
                                ...
                                <tr style="text-align:left;font-size:12px;">
                                    ...
                                    <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"
                                        colspan="4">&nbsp;&nbsp;Estimate
                                        No&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->JobEstimateNo ?></td>
                                    <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;"
                                        colspan="1"></td>
                                </tr>
                                <tr style="text-align:left;font-size:12px;">
                                    ...
                                    <td style="font-size:12px;text-align: left;border-left: 1px solid #000;width:200px;"
                                        colspan="4">&nbsp;&nbsp;Invoice
                                        No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->JobInvNo ?></td>
                                    <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;"
                                        colspan="1"></td>
                                </tr>
                                <tr style="text-align:left;font-size:12px;">
                                    ...
                                    <td style="font-size:12px;text-align: left;border-left: 1px solid #000;border-bottom: 1px solid #000;width:200px;"
                                        colspan="4">&nbsp;&nbsp;Job
                                        No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $invHed->jobcardNo ?>
                                    </td>
                                    <td style="font-size:12px;text-align: left;border-top: 1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;"
                                        colspan="1"></td>
                                ...
                                <tr style="text-align:left;font-size:13px;">
                                    ...
                                    <td
                                        style="font-size:11px;text-align:right;border-right: 1px solid #000;border-left: 1px solid #000;">
                                    </td>
                                    <td style=""></td>
                                    <td colspan="3"
                                        style="font-size:11px;text-align:right;border-right: 1px solid #000;"></td>
                                </tr>
                                <tr>
                                ...
                                <tr style="line-height: 20px;!important;">
                                    ...
                                    <th colspan="2"
                                        style="font-weight:bold;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;text-align:center;width:17%; "
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class='text-right'
                                        style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">
                                        &nbsp;&nbsp;<?php echo number_format($inv->JobDiscount,2)?></td>
                                    <td class='text-right' colspan="2"
                                        style="border-bottom:1px solid #000;border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;">
                                        &nbsp;&nbsp;<?php echo number_format(($inv->JobQty*$inv->JobPrice)-$inv->JobDiscount,2)?>
                                    </td>
                                </tr>
                                <?php $i++; } ?>
                                <?php } ?>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th
                                        style='text-align:right;font-size: 12px;border-top:1px solid #000;border-right: 1px solid #000;'>
                                        SUB TOTAL &nbsp;&nbsp;</th>
                                    <th colspan="" style="border-top:1px solid #000;text-align:center;">&nbsp;&nbsp;Rs.
                                    </th>
                                    <th id="totalAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;'>
                                        <?php echo number_format($invHed->JobTotalAmount,2); ?></th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th id="totalAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;'>
                                        <?php echo number_format($invHed->JobTotalAmount-$invHed->JobTotalDiscount,2); ?>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <th
                                        ...
                                        TOTAL &nbsp;&nbsp;</th>
                                    <th
                                        style="border-left: 1px solid #000;border-top:1px solid #000;border-bottom:1px  solid  #000;text-align:center;">
                                        &nbsp;&nbsp;Rs.</th>
                                    <th id="netAmount"
                                        style='text-align:right;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;'>
                        ...
                        <table id="tbl_est_data"
                            ...
                            <tr>
                                ...
                                <th>&nbsp;&nbsp;</th>
                                <th
                                    style="border-left: 1px solid #000;border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;width:12%">
                                    &nbsp;&nbsp; SUB TOTAL</th>
                                <th
                                    style="border-left: 1px solid #000;border-top:1px solid #000;;border-bottom:1px  solid  #000;text-align:center;width:5%">
                                    Rs.</th>
                                <th id="totalAdvance"
                                    style="border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;text-align:right;width:8%">
                                    <?php echo number_format(($invHed->JobTotalAmount-$invHed->JobTotalDiscount)-((($invHed->JobTotalAmount-$invHed->JobTotalDiscount)*18)/(118)),2); ?>
                                </th>
                            </tr>
                            <tr>
                                <th>&nbsp;&nbsp;</th>
                                ...
                                <th id="totalAdvance"
                                    style="border-top:1px solid #000;border-right: 1px solid #000;;border-bottom:1px  solid  #000;text-align:right;width:8%">
                                    <?php echo number_format((($invHed->JobTotalAmount-$invHed->JobTotalDiscount)*18)/(118),2);?>
                                </th>
                            </tr>
                        ...
                        <table id="footer" style="border-collapse:collapse;width:700px;padding:5px;font-size:12px;"
                            border="1">
                            <tr>
                        ...
                        <table id="footer"
                                    style="border-collapse:collapse;width:700px;padding:5px;font-size:12px;" border="1">
                                    <tr>
            ...
            <div class="col-lg-4">
                <table class="table">
                    ...
                    <tr>
                        <td>Create Date</td>
                        <td>:</td>
                        <td><?php echo $invHed->date ?></td>
                    </tr>
                    <!-- <tr>
                        <td>Job. Inv. No</td>
                        <td>:</td>
                        <td><?php if($invHed->IsInvoice==1){?>Created<?php }else{ ?>Pending<?php } ?></td>
                    </tr> -->
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="row" id="printArea2" align="center" style='margin:5px;'>
                    <table
                        style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif;font-size:14px;"
                        border="0">
            ...
            echo strtoupper($amount)?> ONLY</td>
                        ...
                        <tr style="text-align:left;">
                            <td>Amount</td>
                            <td>:</td>
                            <td colspan="2" id="lblamount">Rs.<?php echo number_format($card_pay->JobInvPayAmount,2);?>
                            </td>
                            <td></td>
                            <td></td>
                            <td>&nbsp;</td>
                        ...
                        <tr style="text-align:left;">
                            ...
                            <td></td>
                            <!-- <td>&nbsp;</td> -->
                            <td colspan="4" style="text-align: right;"> ( Subject to realization of remittance
                                )&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <!-- <td>&nbsp;</td> -->
                        </tr>
                        <tr style="text-align:left;">
        ...
        <div class="modal-content">
            ...
            echo strtoupper($amount)?> ONLY</td>
                        ...
                        <tr style="text-align:left;">
                            <td>Amount</td>
                            <td>:</td>
                            <td colspan="2" id="lblamount">
                                Rs.<?php echo number_format($cheque_pay->JobInvPayAmount,2);?></td>
                            <td></td>
                            <td></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="row" id="printArea_" align="center" style='margin:5px;'>
                    ...
                    <table
                        style="border-collapse:collapse;width:590px;margin:5px;font-family: Arial, Helvetica, sans-serif;"
                        ...
                        <tr style="text-align:left;font-size:14px;">
                            <td colspan="3" rowspan="7">
                                <TABLE style="text-align:left;font-size:14px;margin-left: 5px;">
                                    ...
                                    <tr style="text-align:left;">
                                        <td colspan="3"><span id="lblcusCode"><?php echo $invHed->customerCode;?></span>
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Contact Name <span
                                                id="lblConName"> <?php echo $invVehi->contactName;?></span></td>
                                    </tr>
                                    <tr style="text-align:left;">
                                        <td id="lblcusName" colspan="3"><?php echo $invCus->DisplayName;?></td>
                                    </tr>
                                    <tr style="text-align:left;">
                                        <td id="lblcusName" colspan="3"><?php echo nl2br($invCus->Address01).",<br> ";?>
                                        </td>
                                    </tr>
                                    <tr style="text-align:left;">
                                        <td colspan="3">&nbsp;</td>
                                    ...
                                    <tr style="text-align:left;">
                                        <td> Tel : </td>
                                        <td id="lbltel" colspan="2">
                                            <?php echo $invCus->MobileNo.", ".$invCus->LanLineNo;?></td>
                                    </tr>
                                </TABLE>
                            </td>
                        </tr>
              ...
              $noofjob=0;$refno=0;$nextService=0;
                    ...
                    <table id="tbl_est_data"
                        style="border-collapse:collapse;width:590px;padding:5px;font-size:12px; margin-right: 220px;"
                        align="center" border="0">
                        <tbody>
                          ...
                          // var_dump($invDtl);die;
                                 foreach ($invDtl AS $key=>$invdata) {
                                 //if($key!='PARTS2'){ ?>
                            <tr style="line-height: 5px;background-color:#e4dbdb !important;color:#000 !important;">
                                <td style=""></td>
                            ...
                            <tr style="line-height: 5px">
                                ...
                                <td class='text-right' style="border-bottom:1px dotted #e4dbdb;">
                                    <?php echo number_format($inv->JobQty,2)?></td>
                                <td class='text-right' style="border-bottom:1px dotted #e4dbdb;">
                                    <?php echo number_format($inv->JobPrice,2)?></td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th colspan="4"
                                    style='text-align:right;border-left:1px #fff solid;border-bottom:1px #fff solid; '>
                                </th>
                            ...
                            <tr>
                                <th colspan="4"
                                    style='text-align:right;border-left:1px #fff solid;border-bottom:1px #fff solid;font-weight: normal;text-align: left;'>
                                </th>
                                <th style='text-align:right;border-left:1px #fff solid;border-bottom:1px #fff solid;'>
                                    VAT &nbsp;&nbsp;</th>
                                <th style="border-right: 1px solid #fff;">Rs.</th>
                    ...
                    <br />
                    <table
                        style="border-collapse:collapse;width:683px;padding:2px; position: relative;bottom: 20px; margin-right: 220px;"
                        align="center" border="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td style="text-align: center;"><?php //echo $invjob->first_name;?></td>
                                <td>&nbsp;</td>
                                <td colspan="2"></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="border-top:1px dashed #000;text-align: center;width:100px;">Check by</td>
                                <td style="width: 20px;">&nbsp;</td>
                                <td style="border-top:1px dashed #000;text-align: center;width:100px;">Prepared By</td>
                                <td style="width:20px;">&nbsp;</td>
                                <td colspan="2" style="border-top:1px dashed #000;text-align: center;font-size: 10px;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;width:100px;"></td>
                                <td style="width: 20px;">&nbsp;</td>
                                <td colspan="2" style="font-size: 11px;">I am satisfied with service / goods I received
                                </td>
                                <td style="width:200px;"></td>
                            </tr>
                            <tr>
                                <td style="text-align: left;width:100px;"><b>Remarks</b></td>
                                <td colspan="6">&nbsp;</td>
                            </tr>
                            <tr>
                                <td colspan="7" style="border:1px solid #000;height: 30px;">&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="font-size: 11px;"><?php //echo date('d-m-Y');?></td>
...
function printinv(invoice) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#netAmount').html(accounting.formatMoney(resultData.head.JobNetAmount - resultData.head
                .JobAdvance));
            ...
            $.each(resultData.list, function(key, value) {
                $("#tbl_est_data").append(
                    "<tr><td colspan='6' style='padding: 4px 3px 4px 50px;'><b>" + key +
                    "</b></td></tr>");
                for (var i = 0; i < value.length; i++) {
                    $("#tbl_est_data tbody").append(
                        "<tr><td style='text-align:center;padding: 3px;'>" + (k) +
                        "</td><td style='padding: 3px;'>" + value[i].JobDescription +
                        "</td><td style='padding: 3px;'> </td><td style='text-align:right;padding: 3px;'>" +
                        accounting.formatMoney(value[i].JobQty) +
                        "</td><td  style='text-align:right;padding: 3px;'>" + accounting
                        .formatMoney(value[i].JobPrice) +
                        "</td><td  style='text-align:right;padding: 3px;'>" + accounting
                        .formatMoney(value[i].JobNetAmount) + "</td></tr>");
                    k++;
                }
            });
