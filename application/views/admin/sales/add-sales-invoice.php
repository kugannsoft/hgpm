                        ...
                        <div class="col-md-4">
                            <form class="form-horizontal" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="po_number" class="form-control" id="po_number" placeholder="PO Number" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <form class="form-horizontal" id="formProduct">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <!-- <div class="col-sm-8"><span id="productName" style="font-size: 10px;"></span><span id="proStock"></span>
