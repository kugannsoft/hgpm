        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-success">
                    ...
                    <hr>
                    <div id="stockSec">
                        main Stock = <span style="font-weight:bold;" id="stock"></span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        Stock = <span style="font-weight:bold;" id="pricestock"></span>
                    </div>
                    <div class="row row-eq-height">
                        <div class="col-sm-2">
                            <div  class="form-group">
                        ...
                        <div class="col-sm-1">
                            <div  class="form-group">
                            <input type="number" class="form-control" required onfocus="this.select();"
                                name="qty" id="qty" min="0"  step="0.01"
                                placeholder="Enter Qty (Max 1 decimal)">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div  class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select  class="form-control" name="status"  id="status" >
                                        ...
                                        <option value="2">Parts Complete</option>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <div class="dropdown-item">
                                            <input type="checkbox" id="select_all" class="select-all"> <label for="select_all"><strong>Select All</strong></label>
                                        </div>
                                        <?php foreach ($salespersons as $trns) { ?>
                                            <div class="dropdown-item">
                                                <input type="checkbox" name="employees[]" value="<?php echo $trns->RepID; ?>" id="emp_<?php echo $trns->RepID; ?>">
                                                <label for="emp_<?php echo $trns->RepID; ?>"><?php echo $trns->RepName; ?></label>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
