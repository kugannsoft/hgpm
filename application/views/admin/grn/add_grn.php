                    ...
                    <div class="row" style="background: #D0D0D0;"><br>
                        ...
                        <div  class="col-md-5">
                            <form class="form-horizontal" >
                                ...
                                <div class="form-group">
                                    <label for="additional" class="col-sm-4 control-label">Supplier Creadit Limits</label>
                                    <div class="col-sm-8">
                                       
                                        <span id="creditLimit" name="creditLimit"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="additional" class="col-sm-4 control-label">Manual GRN Amount</label>
                                    <div class="col-sm-7">
                                        <input type="number" tabindex="6"  min="0" step="200" name="manualGrn" value="0" id="manualGrn" class="form-control" />
                                    </div>
                                </div>
                        ...
                        <div  class="col-md-3">
                            ...
                            <table style="font-size: 18px;">
                                ...
                                <tr>
                                    <td>GRN VAT Amount</td>
                                    <td>:</td>
                                    <td class="text-right"><span id="totalVat">0.00</span></td>
                                </tr>
                                <tr style="color: green;">
                                    <td>Total GRN with VAT Amount</td>
                                    <td>:</td>
                                    <td class="text-right"><span id="totalGrnVat">0.00</span></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
...
<!--                                                <select class="form-control"  name="itemCode" id="itemCode">
                                    ...
                                    <div id="productLable" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- <input class="prd_icheck" type="checkbox" name="isProNbt"  id="isProNbt" value="1"> SST -->
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="buyAmount" class="col-sm-4 control-label">Selling Cost percentage %<span class="required"></span></label>
                                            <div class="col-sm-7">
                                                <input type="number" min="0"  tabindex="16"  step="5" pattern="[0-9]*" class="form-control" required="required"  name="selPercent" id="selPercent" placeholder="Enter Selling Percentage" value="0">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="hidden" class="form-control" required="required"  name="isMP" id="isMP">
                                            </div>
                                        </div>
