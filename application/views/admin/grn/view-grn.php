                ...
                <div class="box box-success">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-4">
                                <table class="table">
                                    <tr><td></td><td></td><td class="text-right"><?php if($grn_hed->GRN_No==0){
                                ...
                                <tr><td>Supplier</td><td>:</td><td class="text-right"  id="totalNet"><?php echo $grn_hed->SupName;?></td>
                                    <tr><td>Invoice No:</td><td>:</td><td class="text-right"  id="totalNet"><?php echo $grn_hed->GRN_InvoiceNo;?></td></tr>
