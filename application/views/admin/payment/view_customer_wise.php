                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php
                                        if ($checkRole != 6) {
                                            echo form_open_multipart('admin/payment/cus_upload');?>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php foreach($temp_inv as $v){?>
                                            <tr>
                                                ...
                                                <td><a href=""><?php echo $v->JobInvNo;?></a></td>
                                                <td><?php echo ($v->JRegNo);?></td>
                                                <td><?php echo number_format($v->JobTotalAmount,2);?></td>
                                                <td><?php if ($v->IsInvoice == 0 && $v->IsCancel == 0) { ?> <a href="" class="btn btn-xs btn-warning" >EDIT</a> <?php }
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php foreach($sale as $v){?>
                                            <tr>
                                                ...
                                                <td><a href=""><?php echo $v->SalesInvNo;?></a></td>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php foreach($job_card as $v){?>
                                            <tr>
                                                ...
                                                <td><a href=""><?php echo $v->JobCardNo;?></a></td>
                                                <td><?php echo ($v->JRegNo);?></td>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php foreach($payadd as $v){?>
                                            <tr>
                                                ...
                                                <td><a href=""><?php echo $v->CusPayNo;?></a></td>
                                                <?php //} ?>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php foreach($credit_inv as $v){?>
                                            <tr>
                                                ...
                                                <?php  }elseif ($v->Type==1) { ?>
                                                    <td><a href=""><?php echo $v->InvoiceNo;?></a></td>
                                                <?php }elseif ($v->Type==2) { ?>
                                                    <td><a href=""><?php echo $v->InvoiceNo;?> Return</a></td>
                                                <?php }elseif ($v->Type==0) { ?>
                                                    <td><a href=""><?php echo $v->InvoiceNo;?></a></td>
                                                <?php } ?>
                                                <td><?php echo number_format($v->CreditAmount,2);?></td>
                                                <td><?php echo number_format($v->SettledAmount,2);?></td>
                                                <td><?php echo number_format($v->returnAmounts,2);?></td>
                                                <td><?php echo number_format($v->CreditAmount - $v->SettledAmount - $v->returnAmounts,2);?></td>
                                                <td><?php
                                                    //shalika
                                                    ...
                                                    if (($v->returnAmounts!=0) && ($v->CreditAmount == $v->returnAmounts)) {
...
//                                                        echo printStats($v->IsCloseInvoice,'Closed','success','Returned','danger','warning');
                                                    }elseif (($v->returnAmounts!=0) && ($v->CreditAmount > $v->returnAmounts)) {
                                                        echo "<label class='label label-danger'>Partial-Returned</label>";
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        foreach($job_estall as $v){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href=""><?php echo $v->EstimateNo;?></a></td>
