                    ...
                    <div class="box-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="selectedAmount" class="col-sm-5 control-label">Cash Flot Type<span class="required">*</span></label>
                                    <div class="col-sm-6">
                                    <select class="form-control" id="cashType">
                                            <option value="2">Main Cash</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <table>
                                    ...
                                    <tr>
                                        <td>Available Return Limit</td>
                                        <td> : </td>
                                        <td class="text-right"><span id="availableReturnLimit"></span> </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
...
<!--                                             <b> Cash Payment : <span id="cashPayment"></span> </b><br>
                                ...
                                <span class="thumbnail"> 
                                    <!-- &nbsp; &nbsp; Automatically &nbsp;<input type="radio"  class="prd_icheck" checked="checked" name="payAuto" id="payAuto" value="1">   -->
