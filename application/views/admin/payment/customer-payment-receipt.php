    ...
    <div class="box-header" style="background: #b4f3c8">
        ...
        <div class="col-sm-7">
            <div class="row">
                ...
                <div class="col-sm-2"><button type="button" id="btnPrint2"
                        class="btn btn-primary btn-sm btn-block">Customer Print</button></div>
                <div class="col-sm-2"><button type="button" id="btnPrint3"
                        class="btn btn-primary btn-sm btn-block">Office Print</button></div>
                <!--div class="col-sm-1">
                ...
                <div class="row" align="center" style='margin:5px;'>
                    <div class="row" id="printArea3" align="center" style='margin:5px;'>
                        <div id="customercopy">
                            ...
                            <table
                                style="border-collapse:collapse;width:700px;margin:5px;font-family: Arial, Helvetica, sans-serif;font-size:12px;"
                                border="0">
                                ...
                                <tr style="text-align:left;">
                                    ...
                                    <!-- <td>&nbsp;</td>-->
                                    <td>&nbsp;</td>
                                    <td colspan="2" style='font-size: 20px;text-align: center;'><b>Customer Copy</b>
                                    </td>
                                    <td>DATE</td>
                                    <td>:</td>
                                ...
                                <tr style="text-align:left;">
                                    <td colspan="3"></td>
                                    <td>:</td>
                                    <td colspan="4" id="chq_rcpcusaddress" rowspan="3">
                                        <?php echo $pay->Address01."<br>".$pay->Address02." ".$pay->Address03; ?></td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr style="text-align:left;">
                                    <td colspan="3"></td>
                                ...
                                <tr style="text-align:left;">
                                    <td>Amount</td>
                                    <td>:</td>
                                    <td colspan="2" id="chq_rcpamount">
                                        Rs.<?php echo number_format($pay->PayAmount,2); ?></td>
                                    <td></td>
                                    <td></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr style="text-align:left;">
                                   ...
                                   <tr style="text-align:left;">
                                        <td>Created By</td>
                                        <td>:</td>
                                        <td colspan="2"  id="chq_rcppaytype"><?php echo $pay->first_name." ".$pay->last_name ?></td>
                                        <td></td>
                                        <td colspan="2"></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
            ...
            <div class="col-lg-4">
                <table class="table">
                    ...
                    <tr>
                        <td>Cancel Date</td>
                        <td>:</td>
                        <td><?php echo $cancel->CancelDate ?></td>
                    </tr>
                    <tr>
                        <td>Remark</td>
                        <td>:</td>
                        <td><?php echo $cancel->CancelRemark ?></td>
                    </tr>
                    <?php endif; ?>
                    <!--  <?php if($invUpdate):  ?>
...
$(document).ready(function() {
    ...
    $("h3[class^=pag]").each(function() {
        ...
        document.styleSheets[0].addRule('h3.pag' + numId + '::before', 'content: "Page ' + numId +
            ' of ' + pagTotalString + '";');
    });
});
