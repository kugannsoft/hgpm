...
<script src="<?php echo base_url('assets/plugins/notify.min.js'); ?>"></script>
        ...
        <?php if($this->router->fetch_class() == 'Salesinvoice'): ?>
            ...
            <script src="<?php echo base_url('assets/frameworks/job/job_invoice1.11.js'); ?>"></script>
        ...
        <?php if ($this->router->fetch_class() == 'purchase'): ?>
            ...
            <?php endif; ?>
            <?php if ($this->router->fetch_method() == 'po_return'): ?>
                <script src="<?php echo base_url('assets/frameworks/pos/po_return.js'); ?>"></script>
            <?php endif; ?>
    <?php endif; ?>
