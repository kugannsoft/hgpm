    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?= active_link_controller('report') ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?= active_link_controller('report') ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="<?= active_link_function('jobsalesbyservice') ?>">
                                <a href="<?php echo site_url('admin/report/jobsalesbyservice'); ?>">Work Type Wise Job
                                    sale</a>
                            </li>
                    ...
                    <li class="<?= active_link_controller('report') ?>">
                        ...
                        <ul class="treeview-menu">
                            <li class="<?= active_link_function('salesbydate') ?>">
                                <a href="<?php echo site_url('admin/report/salesbydate'); ?>">Count sale</a>
                            </li>
                    ...
                    <li class="<?= active_link_controller('report') ?>">
                        ...
                        <ul class="treeview-menu">
                            <li class="<?= active_link_function('grnreport') ?>">
                                <a href="<?php echo site_url('admin/report/grnreport'); ?>">Goods Recevied Note by Grn</a>
                            </li>
                        </ul>
                        <ul class="treeview-menu">
                            <li class="<?= active_link_function('grnreport') ?>">
                                <a href="<?php echo site_url('admin/report/grnreportbyproduct'); ?>">Goods Recevied Note by Product</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="treeview-menu">
                    <li class="<?= active_link_controller('report') ?>">
                        <a href="#"><i class="fa fa-gratipay"></i><span>Customer Outstanding Report</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                ...
                <ul class="treeview-menu">
                    <li class="<?= active_link_controller('report') ?>">
                        <a href="#"><i class="fa fa-gratipay"></i><span>Supplier Outstanding Report</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="<?= active_link_function('suppliercreditoutstanding') ?>">
                                <a href="<?php echo site_url('admin/report/suppliercreditoutstanding'); ?>">Supplier Outstanding
                                    Detail</a>
                            </li>
                            <li class="<?= active_link_function('suppliercreditsummary') ?>">
                                <a href="<?php echo site_url('admin/report/suppliercreditsummary'); ?>">Supplier
                                Outstanding Summary</a>
                            </li>
                            <!-- <li class="">
                                <a href="#">Supplier Payments</a>
                ...
                <ul class="treeview-menu">
                 ...
                 <ul class="treeview-menu">
                    <li class="<?= active_link_controller('report') ?>">
                        <a href="#"><i class="fa fa-gratipay"></i><span>Employee Report</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <!-- <li class="<?= active_link_function('employeesalesumbydate') ?>">
                                <a href="<?php echo site_url('admin/report/employeesalesumbydate'); ?>">Employee wise sale</a>
                            </li>
                            <li class="<?= active_link_function('jobsalesbyserviceforemployee') ?>">
                                <a href="<?php echo site_url('admin/report/jobsalesbyserviceforemployee'); ?>">Employee Wise sale For Labour</a>
                            </li> -->
            ...
            <li class="treeview <?= active_link_controller('purchase') ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?= active_link_function('all_po') ?>"><a
                                href="<?php echo site_url('admin/purchase/all_po'); ?>">All PO</a>
                    </li>
                    <li class="<?= active_link_function('addprn') ?>"><a
                                href="<?php echo site_url('admin/purchase/addprn'); ?>">Purchase Return Note</a>
                    </li>
                    <li class="<?= active_link_function('all_retnprn') ?>"><a
                                href="<?php echo site_url('admin/purchase/all_retnprn'); ?>">All Return PO</a>
                    </li>
