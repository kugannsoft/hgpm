...
<table style="border-collapse:collapse;width:500px;margin:5px;font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif;" border="0">
    <tr style="text-align:left;font-size:35px;font-family: Arial, Helvetica, sans-serif;">
        ...
        <td colspan="5" style="font-size:35px;font-family: Arial, Helvetica, sans-serif;text-align: left;"><b> &nbsp;&nbsp;&nbsp;<?php echo $company['CompanyName'] ?> <?php echo $company['CompanyName2'] ?></b>
        </td>
        
    </tr> 
    <tr style="text-align:left;color:#9a9494 !important;font-size:16px;font-family: Arial, Helvetica, sans-serif;">
        <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $company['AddressLine01'] ?><?php echo $company['AddressLine02'] ?><?php echo $company['AddressLine03'] ?></td>
    </tr>
    <!--<tr style="text-align:center;color:#9a9494 !important;font-size:13px;font-family: Arial, Helvetica, sans-serif;">-->
