                          ...
                          <tr>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th id="totalbank" style="text-align: right;color: #00aaf1;"></th>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td colspan="5"></td>
                                    <td id="" style="color:#f00;font-weight:bold;text-align:right" colspan="2"></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
...
<script>
 ...
 $("#route").change(function(){
    ...
    $('#filterform').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#totalbank').html(accounting.formatMoney(sumcolumn('bankamount')));
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td class='bankamount' align='right'>" + accounting.formatMoney(rowData.BankAmount) + "</td>"));
    ...
    function printdiv() {
        $("#saletable").print({
            prepend:"<h3 style='text-align:center'>Count Sale Report</h3><hr/>",
            title:'Count Sale'
        });
    }
