                        ...
                        <table id="saletable" class="table table-bordered">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="" style="color:#f00;font-weight:bold">Total</td>
                                    <td id="totalcost" style="color:#f00;font-weight:bold"></td>
                                    <td id="totalsell" style="color:#f00;font-weight:bold"></td>
...
<script>
 ...
 $("#route").change(function(){
    ...
    $('#filterform').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#totalcost').html(accounting.formatMoney(sumcolumn('totalcost')));
                $('#totalsell').html(accounting.formatMoney(sumcolumn('totalsell')));
    ...
    function drawRow(rowData) {
        ...
        row.append($("<td class='totalcost'>" + (accounting.formatMoney(rowData.TotalJobCost) || 0)+ "</td>"));
        row.append($("<td class='totalsell'>" + (accounting.formatMoney(rowData.TotalJobPrice) || 0) + "</td>"));
        row.append($("<td class='total'>" + (accounting.formatMoney(rowData.TotalJobPrice - rowData.TotalJobCost) || 0) + "</td>"));
         row.append($("<td class='total_qty_profit'>" + (accounting.formatMoney(rowData.TotalQtyProfit) || 0) + "</td>"));
    }
    ...
    function printdiv() {
        $("#saletable").print({
            prepend:"<h3 style='text-align:center'>Profit Summary Report</h3><hr/>",
