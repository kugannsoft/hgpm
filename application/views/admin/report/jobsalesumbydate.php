                        ...
                        <table id="saletable" class="table table-bordered">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <!-- <th id="totala" style="color: #00aaf1;"></th>
                                    <th id="totaldia" style="color: #00aaf1;"></th>
                                    <th id="totalca" style="color: #00aaf1;"></th>
                                    <th id="totalcra" style="color: #00aaf1;"></th>
                                    <th id="totalcrda" style="color: #00aaf1;"></th>
                                    <th id="totalcha" style="color: #00aaf1;"></th>
                                    <th id="totalba" style="color: #00aaf1;"></th>
                                    <th id="totalneta" style="color: #00aaf1;"></th> -->
                                    <th id="totlalfinalamount" style="color: #00aaf1;"></th>
                                    <!-- <th id="totalneta" style="color: #00aaf1;"></th>
                                    <th id="totalcrda" style="color: #00aaf1;"></th>
                                    <th id="totalca" style="color: #00aaf1;"></th>
                                    <th id="totalcra" style="color: #00aaf1;"></th>
                                    ...
                                    <th id="totala" style="color: #00aaf1;"></th>
                                    <th id="totlalfinalamount" style="color: #00aaf1;"></th> -->
                                    <!-- // row.append($("<td class='totalamount'>" + accounting.formatMoney(rowData.InvAmount) + "</td>"));
        // row.append($("<td class='disamount'>" + accounting.formatMoney(rowData.DisAmount) + "</td>"));
        // row.append($("<td class='cashamount'>" + accounting.formatMoney(rowData.CashAmount) + "</td>"));
        // row.append($("<td class='creditamount'>" + accounting.formatMoney(rowData.CreditAmount) + "</td>"));
        // row.append($("<td class='ccardamount'>" + accounting.formatMoney(rowData.CCardAmount) + "</td>"));
        // row.append($("<td class='chequeamount'>" + accounting.formatMoney(rowData.ChequeAmount) + "</td>"));
        // row.append($("<td class='bankamount'>" + accounting.formatMoney(rowData.JobBankAmount) + "</td>"));
        // row.append($("<td class='netamount'>" + accounting.formatMoney(rowData.AdvanceAmount) + "</td>"));  -->
                                </tr>
                            </tfoot>
                        </table>
                    </div>
    ...
    $('#filterform').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#totalba').html(accounting.formatMoney(sumcolumn('bankamount')));
                $('#totlalfinalamount').html(accounting.formatMoney(sumcolumn('finalamount')));
            }
        })
    });
