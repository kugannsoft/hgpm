        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" step="1" min="0" class="form-control" name="bankname" id="bankname" placeholder="Enter Bank Name">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" step="1" min="0" class="form-control" name="branch_name" id="branch_name" placeholder="Enter Branch Name">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="1" min="0" class="form-control" name="creditlimit" id="creditlimit" placeholder="Enter credit limit">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="1" min="0" class="form-control" name="accno" id="accno" placeholder="Enter Account No">
                </div>
                <div class="form-group">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 1) {
                    ...
                    $.notify("Supplier Saved Sucessfully.", "Success");
                }
            }
        });
    });
