    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label for="creditperiod">Bank Name </label>
                    <input type="text" step="1" min="0" class="form-control" name="bankname" id="bankname" value="<?php echo $supplier->BankName; ?>" placeholder="Enter Bank Name">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="creditperiod">Bank Branch </label>
                    <input type="text" step="1" min="0" class="form-control" name="branch_name" id="branch_name" value="<?php echo $supplier->BranchName; ?>" placeholder="Enter Branch Name">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="creditperiod">Credit Limit </label>
                    <input type="number" step="1" min="0" class="form-control" name="creditlimit" id="creditlimit" value="<?php echo $supplier->CreditLimit ?>" placeholder="Enter credit limit">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="creditperiod">Bank Account No </label>
                    <input type="number" step="1" min="0" class="form-control" name="accno" id="accno" placeholder="Enter Account No" value="<?php echo $supplier->AccNo ?>">
                </div>
                <div class="form-group">
