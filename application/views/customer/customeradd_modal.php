<form id="addcustomerform">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" name="mobileNo" id="mobileNo" placeholder="EX-:0785092933 " maxlength="12" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="phoneNo" id="phoneNo" placeholder="EX-:0785092933" maxlength="12" value="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" name="workPhone" id="workPhone" placeholder="EX-:0115092933 " maxlength="12" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" name="contactPhone" id="contactPhone" placeholder="EX-:0115092933" maxlength="12" value="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row" style="background: rgba(121, 191, 130, 0.37);" id="vehicle_div">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="contactNameV" id="contactNameV" placeholder="Enter Contact name">
                </div>
                <div class="form-group">
                ...
                <!-- <div class="form-group">
                    <label for="fuel">Wheel Type</label>
                    <div class="input-group">
                    ...
                    <div class="form-group">
                            ...
                            <div class="input-group">
                                 ...
                                 <select class="form-control" name="model" id="model">
                                    <option value="">-select-</option>
                                    <?php foreach ($model as $fval) { ?>
                                        <option value="<?php echo $fval->model_id ?>"><?php echo $fval->model ?></option>
                                    <?php } ?>
                                </select>
                                <div class="input-group-btn">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php } ?>
                                ...
                                <div class="input-group-btn">
                                    <button class="btn btn-warning" id="addColor"><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-footer">
        ...
        <a href="#" id="jobLink" class="btn btn-flat btn-primary pull-right disabled">Add Job Card</a>
        <a href="#" id="estLink" class="btn btn-flat btn-primary pull-right disabled">Add Estimate</a>
...
$("#cusName").blur(function(){
    ...
    var capword = cusname.toUpperCase();
    console.log(capword);
    $("#cusName").val(capword);
        $("#displayName").val(capword);
...
function generateEstLink(cus_code,RegNo){
        $("#estLink").attr('disabled',false);
        if(cus_code!='' && RegNo!=''){
            $("#estLink").attr("href", "../../admin/job/estimate_job?type=cus&ccode=" + Base64.encode(cus_code) + "&regno=" + Base64.encode(RegNo));
           
        }
    }

    function genarateJobLink(cus_code,RegNo){
        $("#jobLink").attr('disabled',false);
        if(cus_code!='' && RegNo!=''){
            $("#jobLink").attr("href","../../admin/job/index?type=cus&ccode="+Base64.encode(cus_code) + "&regno=" + Base64.encode(RegNo)); 
...
$('#cusName,#LastName,#companyName,#contactNameV').keyup(function(){
    setDisplayType();
});
...
function setDisplayType(){
    ...
    $("#contactNameV").val(respectSign+". "+cusName);
...
$("input[name='Isvehicle']").click(function(){
    ...
    if(isvehi==1){
        newVehicle=1;
        $("#make,#regNo").attr('required',true);
        $("#vehicle_div").show();
    }else{
        newVehicle=0;
        $("#make,#regNo").attr('required',false);
        $("#vehicle_div").hide();
    }
});
		    ...
		    $.ajax({
		            ...
		            success: function (status) {
		                if (status){
                            ...
                            $("#estLink").attr('disabled',false);
                            $("#jobLink").attr('disabled',false);
                            $("#estLink, #jobLink").removeClass("disabled"); 
		                    generateEstLink(status.cus_code,status.RegNo);
		                     genarateJobLink(status.cus_code,status.RegNo);
		                }else{
