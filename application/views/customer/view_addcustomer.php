    ...
    var customertbl = $('#customertbl').dataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "data": null, orderable: false, searchable: false,
                mRender: function (data, type, row) {
                    return '<button onclick="addvehiclem(\'' + row.CusCode + '\')" class="btn btn-xs btn-default" >Add V</button>';
                }
                <?PHP  } else {?>
                "data": null, orderable: false, searchable: false,
                mRender: function (data, type, row) {
                    return '<button onclick="addvehiclem(\'' + row.CusCode + '\')" class="btn btn-xs btn-default" disabled>Add V</button>';
                }
                <?php }?>
            },
            {
