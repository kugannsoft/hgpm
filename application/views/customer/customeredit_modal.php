    ...
    <input type="hidden" name="userid" value="<?php echo $cusdata->CusCode; ?>" />
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $cusdata->Nic; ?>" name="nic" id="nic" placeholder="NIC No Or Passport No">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" value="<?php echo $cusdata->MobileNo; ?>"  name="mobileNo" id="mobileNo" placeholder="EX-:0785092933" maxlength="12" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" value="<?php echo $cusdata->LanLineNo; ?>" name="phoneNo" id="phoneNo" placeholder="EX-:0785092933" maxlength="12" value="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" value="<?php echo $cusdata->WorkNo; ?>" name="workPhone" id="workPhone" placeholder="EX-:0115092933" maxlength="12" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" name="contactPhone"  value="<?php echo $cusdata->ContactNo; ?>" id="contactPhone" placeholder="EX-:0115092933" maxlength="12" value="">
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <!--            <div class="form-group">
            ...
            <button class="btn btn-success btn-flat" type="submit">Update Customer</button>
            </div>
        </form>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="chassisNo">Chassis No </label>
                                    <input type="text"  class="form-control" maxlength="17" name="chassisNo" id="chassisNo" placeholder="Enter Chassis No">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
