    ...
    <div class="row" style="background: rgba(121, 191, 130, 0.37);">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="regNo" id="regNo" required placeholder="Enter Registration No">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="engineNo">Service Interval (Km)</label>
                    <input type="text" class="form-control" name="engineNo" id="engineNo" placeholder="Enter Service Interval">
                </div>
            </div>
        </div>
        ...
        <div class="row" style="background: rgba(121, 191, 130, 0.37);">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="manufactureYear">Date of Registration</label>
        ...
        <div class="row" style="background: rgba(121, 191, 130, 0.37);">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group" id="panel_manYear">
                    <input type="number" class="form-control pull-right" name="manYearName" id="manYearName">
