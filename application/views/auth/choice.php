...
<div class="col-lg-12">
    <table style="border-collapse:collapse;width: 100%;" border="0">
                                   <?php $checkRole = $_SESSION['role'];  if ($checkRole == 6) { ?>
                                    <tr style="text-align:center;font-size:25px;">
                                           <td colspan="4"><h1>Well Come To Customer Portal</h1></td>
                                    </tr>
                                    <tr style="text-align:center;font-size:25px;">
...
<!--                                 <tr style="text-align:center;font-size:20px;">
                                ...
                                <tr style="text-align:center;font-size:20px;">
                                    <td colspan="2"><a href="<?php echo site_url('admin'); ?>"  class="btn btn-success btn-lg" > <i class="fa fa-sign-in"></i> <?php $checkRole = $_SESSION['role'];  if ($checkRole == 6) { ?> Login <?php } else { ?> Admin <?php } ?></a></td>
